...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar do wesley" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Wesley</p>
        <h1>Eu sou estudante</h1>
        <p>Eu sou vagabundo, fiz curso de tecnologia e lider de grupo. Veja os projetos
            que já desenvolvi!</p>
    ...
    <footer class="container py-5">
        ...
        <div>
            <i class="bi bi-github"></i>Add commentMore actions
